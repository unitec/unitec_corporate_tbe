...
if (strpos($checkuseragent, 'MSIE 7')) {
	echo get_string('ie7message', 'theme_unitec_corporate_tbe');
}?>
...
<?php
	...
	<?php
        ...
        <p id="socialheading"><?php echo get_string('socialnetworks','theme_unitec_corporate_tbe')?></p>
            <ul class="socials unstyled">
                <?php if ($haswebsite) { ?>
        ...
        <p id="socialheading"><?php echo get_string('mobileappsheading','theme_unitec_corporate_tbe')?></p>
            <ul class="socials unstyled">
                <?php if ($hasios) { ?>
