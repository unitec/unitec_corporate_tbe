...
$THEME->name = 'unitec_corporate_tbe';

// The only thing you need to change in this file when copying it to
// create a new theme is the name above. You also need to change the name
// in version.php and lang/en/theme_unitec_corporate_tbe.php as well.
...
$THEME->csspostprocess = 'theme_unitec_corporate_tbe_process_css';
